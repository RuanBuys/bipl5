...
#' @srrstatsNA {G1.6} No claims against other software
#'
#' @srrstatsNA {G2.5} No explicit factor input required
#' @srrstatsNA {G5.9} No noise involved anywhere
#' @srrstatsNA {G5.9a} No noise added to any data
#' @srrstatsNA {G5.9b} No randomness involved
#' @srrstatsNA {G5.10} No extended test
#' @srrstatsNA {G5.11} No extended test
#' @srrstatsNA {G5.11a} No downloads of additional data necessary
#' @srrstatsNA {G5.12} Not applicable. No extended tests on platforms needed
#' @noRd
NULL
